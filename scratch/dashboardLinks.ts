export const megaMenuGroups = [
  {
    ...
    items: [
      ...
      { text: 'Mẫu sổ  S1a-HKD (Doanh thu từ 500 triệu trở xuống)', href: '/report/household/s1a?businessId=122623' },
      { text: 'Mẫu sổ  S2a-HKD (Doanh thu trên 500 triệu đến 3 tỷ)', href: '/report/household/s2a?businessId=122623' },
      { text: 'Mẫu sổ  S2b-HKD (Doanh thu trên 3 tỷ)', href: '/report/household/s2b?businessId=122623' },
      { text: 'Mẫu sổ  S2b-HKD (Doanh thu trên 3 tỷ)', href: '/report/household/s2b?businessId=122623' },
      { text: 'Mẫu sổ  S2c-HKD (Sổ chi tiết doanh thu, chi phí)', href: '/report/household/s2c?businessId=122623' },
      { text: 'Mẫu sổ  S2d-HKD (Sổ chi tiết vật liệu, dụng cụ, sản phẩm, hàng hóa)', href: '/report/household/s2d?businessId=122623' },
      ...
      { text: 'Tiền quảng cáo', href: '/ecommerce/manage/reportads?businessId=122623' },
      { text: 'Báo cáo', href: '/report/revenue/index?businessId=122623' },
    ]
  },
  {
    ...
    items: [
      ...
      { text: 'Sản phẩm', href: '/ecommerce/shopee/product?businessId=122623' },
      { text: 'Đánh giá', href: '/ecommerce/shopee/productreview?businessId=122623' },
      { text: 'Sản phẩm', href: '/ecommerce/tiktok/product?businessId=122623' },
      { text: 'Sản phẩm', href: '/ecommerce/lazada/product?businessId=122623' },
      { text: 'Đánh giá', href: '/ecommerce/lazada/productreview?businessId=122623' },
      { text: 'Sản phẩm', href: '/ecommerce/tiki/product?businessId=122623' },
      { text: 'Sản phẩm', href: '/ecommerce/meta/product?businessId=122623' },
      { text: 'Sản phẩm', href: '/invoice/product/index?businessId=122623' },
      { text: 'Nhà cung cấp', href: '/accounting/debts/supplier?businessId=122623' },
      { text: 'Comment sản phẩm', href: '/social/comment/product?businessId=122623' },
      { text: 'Đánh giá sản phẩm', href: '/social/rating/product?businessId=122623' },
      { text: 'Sản phẩm', href: '/product/item/index?businessId=122623' },
      { text: 'Kho hàng', href: '/inventory/bill/index?businessId=122623' },
    ]
  },
  {
    ...
    items: [
      ...
      { text: 'Đơn hàng', href: '/ecommerce/shopee/order?businessId=122623' },
      { text: 'Đơn hàng', href: '/ecommerce/tiktok/order?businessId=122623' },
      { text: 'Đơn hàng', href: '/ecommerce/lazada/order?businessId=122623' },
      { text: 'Đơn hàng', href: '/ecommerce/tiki/order?businessId=122623' },
      { text: 'Đơn hàng và vận chuyển', href: '/setting/order/index?businessId=122623' },
      { text: 'Đơn hàng', href: '/order/manage/index?businessId=122623' },
    ]
  },
  {
    ...
    items: [
      ...
      { text: 'Khách hàng', href: '/accounting/debts/customer?businessId=122623' },
      { text: 'Like sản phẩm', href: '/social/like/index?businessId=122623' },
      { text: 'Gửi Zalo', href: '/setting/zalo/index?businessId=122623' },
      { text: 'Gửi SMS', href: '/setting/sms/index?businessId=122623' },
      { text: 'Khách hàng', href: '/customer/code/customerlist?businessId=122623' },
      { text: '[Nạp tiền]', href: '/setting/zalo/index?businessId=122623' },
    ]
  },
  {
    ...
    items: [
      ...
      { text: 'Hóa đơn điện tử', href: '/setting/invoice/index?businessId=122623' },
      { text: 'Kế toán', href: '/accounting/transaction/index?businessId=122623' },
    ]
  },
  {
    title: 'Kênh bán (TMĐT)',
  ...
  },
  {
    title: 'Cài đặt & Khác',
    items: [
      { text: 'Thông báo tính năng Sổ kế toán thêm 2 sổ s2c, s2d', href: '/thong-bao-tinh-nang-so-ke-toan-them-2-so-s2c-s2d-an926.html' },
      { text: 'Thông báo lịch nghỉ lễ Giỗ tổ Hùng Vương, Giải phóng Miền Nam 30/4 và Quốc tế lao động 1/5', href: '/thong-bao-lich-nghi-le-gio-to-hung-vuong-giai-phong-mien-nam-304-va-quoc-te-lao-dong-15-an925.html' },
      { text: 'Thông báo thay đổi bảng giá  BEST EXPRESS', href: '/thong-bao-thay-doi-bang-gia-best-express-an924.html' },
      { text: 'Thông báo mở hỗ trợ địa chỉ 2 cấp cho đơn hàng SPX', href: '/thong-bao-mo-ho-tro-dia-chi-2-cap-cho-don-hang-spx-an923.html' },
      { text: 'Thông báo lịch ngừng hỗ trợ API v2', href: '/thong-bao-lich-ngung-ho-tro-api-v2-an922.html' },
      { text: 'Điều chỉnh phí vận chuyển Viettel Post', href: '/dieu-chinh-phi-van-chuyen-viettel-post-an921.html' },
      { text: 'Thông báo điều chỉnh phí tin nhắn Zalo ZBS (Zalo ZNS)', href: '/thong-bao-dieu-chinh-phi-tin-nhan-zalo-zbs-zalo-zns-an920.html' },
      { text: 'Cải tiến màn hình bán hàng, đơn hàng hỗ trợ chương trình chiết khấu và quà tặng mới', href: '/cai-tien-man-hinh-ban-hang-don-hang-ho-tro-chuong-trinh-chiet-khau-va-qua-tang-moi-an919.html' },
      { text: 'Workshop online miễn phí: 360° QUẢN TRỊ CHI PHÍ QUẢNG CÁO FACEBOOK', href: '/workshop-online-mien-phi-360-quan-tri-chi-phi-quang-cao-facebook-an918.html' },
      { text: 'Thông báo lịch bảo trì server dịp Tết Nguyên Đán 2026', href: '/thong-bao-lich-bao-tri-server-dip-tet-nguyen-dan-2026-an917.html' },
      { text: 'Nguồn đơn hàng', href: '/store/traffic/source?businessId=122623' },
      ...
      { text: 'Đại lý', href: '/store/agency/index?businessId=122623' },
      { text: 'Hạn sử dụng', href: '/setting/expire/depot?businessId=122623' },
      { text: 'Business Tools', href: '/business/tool/index?businessId=122623' },
      { text: 'Tổng quan', href: '/admin?businessId=122623' },
      { text: 'Website', href: '/website/content/index?businessId=122623' },
      { text: 'Khuyến mại', href: '/promotion/setting/discount?businessId=122623' },
      { text: 'Cài đặt', href: '/setting/store/index?businessId=122623' },
      { text: 'Thông báo tính năng Sổ kế toán thêm 2 sổ s2c, s2d', href: '/thong-bao-tinh-nang-so-ke-toan-them-2-so-s2c-s2d-an926.html' },
      { text: 'Thông báo lịch nghỉ lễ Giỗ tổ Hùng Vương, Giải phóng Miền Nam 30/4 và Quốc tế lao động 1/5', href: '/thong-bao-lich-nghi-le-gio-to-hung-vuong-giai-phong-mien-nam-304-va-quoc-te-lao-dong-15-an925.html' },
      { text: 'Thông báo thay đổi bảng giá  BEST EXPRESS', href: '/thong-bao-thay-doi-bang-gia-best-express-an924.html' },
      { text: 'Thông báo mở hỗ trợ địa chỉ 2 cấp cho đơn hàng SPX', href: '/thong-bao-mo-ho-tro-dia-chi-2-cap-cho-don-hang-spx-an923.html' },
      ...
      { text: 'Workshop online miễn phí: 360° QUẢN TRỊ CHI PHÍ QUẢNG CÁO FACEBOOK', href: '/workshop-online-mien-phi-360-quan-tri-chi-phi-quang-cao-facebook-an918.html' },
      { text: 'Thông báo lịch bảo trì server dịp Tết Nguyên Đán 2026', href: '/thong-bao-lich-bao-tri-server-dip-tet-nguyen-dan-2026-an917.html' },
      { text: 'Lịch nghỉ Tết Nguyên Đán Bính Ngọ 2026', href: '/lich-nghi-tet-nguyen-dan-binh-ngo-2026-an916.html' },
      { text: 'WORKSHOP ONLINE MIỄN PHÍ: FACEBOOK ADS 2026', href: '/workshop-online-mien-phi-facebook-ads-2026-an915.html' },
      { text: 'Thông báo thay đổi bảng giá SPX', href: '/thong-bao-thay-doi-bang-gia-spx-an914.html' },
      { text: 'Lịch nghỉ Tết dương lịch 2026', href: '/lich-nghi-tet-duong-lich-2026-an913.html' },
      { text: '🔥 [WORKSHOP ONLINE] Khai thác Data có sẵn: Chiến lược chuyển đổi hiệu quả cao - chi phí thấp với tin nhắn quảng cáo Facebook Messenger', href: '/-workshop-online-khai-thac-data-co-san-chien-luoc-chuyen-doi-hieu-qua-cao-chi-phi-thap-voi-tin-nhan-quang-cao-facebook-messenger-an912.html' },
    ]
  },
];
